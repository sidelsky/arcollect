...
<!-- The Modal -->
<div id="myModal" class="modal js-modal">

  <!-- Modal content -->
  <div class="modal-content">
	 <div class="c-videos__inner">
	    <span class="close js-close">&times;</span>
    	<iframe src="https://www.youtube.com/embed/miHHwxEpQIY?rel=0&amp;showinfo=0" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
	 </div>
  </div>
